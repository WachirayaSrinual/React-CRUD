...
export default function BookList() {
  ...
  useEffect(() => {
    axios
      .get("https://node58279-wachinoedrest.proen.app.ruk-com.cloud/books")
      .then((response) => {
  ...
  const viewBook = (id) => {
    axios
      .get(`https://node58279-wachinoedrest.proen.app.ruk-com.cloud/books/${id}`)
      .then((response) => {
  ...
  const updateBook = (book) => {
    ...
    // axios
    //   .put(`https://node58279-wachinoedrest.proen.app.ruk-com.cloud/books/${id}`)
    //   .then((response) => {
    //     setBook(response.data);
    //   });
  };
  ...
  const deleteBook = (id) => {
    axios
      .delete(`https://node58279-wachinoedrest.proen.app.ruk-com.cloud/books/${id}`)
      .then(() => {
